...
- `data/brain/display-titles.batch-9.json` — official CoS batch 9 (`VXGZZirK56I`: Grand Rounds — Sep 17, 2026). Together with batches 1–8 these cover all 385 catalog videos.
