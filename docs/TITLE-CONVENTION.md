...
Official CoS batches live in `data/brain/display-titles.batch-N.json` (batch 1 = series dates; batch 2 = guest/teaching talks; batch 3 = topic polish; batch 4 = early-transcript roster speakers). Later batches win. To add batch 5, drop another file in that folder — see `data/brain/README.md`.
